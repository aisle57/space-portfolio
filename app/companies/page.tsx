...
const productionEnrichment: Company[] = [
  ...
  },
  {
    ...
    focus:
      "Uranium conversion, advanced enrichment pathways, and lithium isotopes.",
    note:
      "Fuel-cycle company under the ASP Isotopes group, not a medical radiopharma manufacturer.",
  },
  {
    name: "Silex Systems",
  ...
  },
  {
    ...
    focus:
      "Commercial isotope products and radiopharmaceutical support systems.",
  },
  {
    name: "IBA",
...
const medicalRadiopharma: Company[] = [
  {
    name: "Novartis",
  ...
  },
  {
    ...
    focus:
      "Mo-99 production technology and medical isotope manufacturing systems.",
  },
  {
  ...
  },
  {
    ...
    note:
      "Planned capacity expansion. Not the same as TerraPower's reactor business.",
  },
  {
    name: "PanTera",
  ...
  },
  {
    ...
    note:
      "Important to the Ac-225 and broader therapeutic isotope commercial chain, especially where production volume and distribution meet.",
  },
  {
    name: "Orano Med",
...
const nationalRegional: Company[] = [
  ...
  },
  {
    name: "POLATOM",
    tags: ["Medical", "Poland"],
    about: "Polish radioisotope producer linked to MARIA reactor pathways.",
...
const strategicNuclear: Company[] = [
  {
  ...
  return (
    <div className="p-5 rounded-xl border border-white/10 bg-white/[0.03]">
      ...
      <p className="text-gray-400 text-sm leading-relaxed mb-2">
        <span className="text-white">Focus:</span> {company.focus}
      </p>
      {company.note ? (
        <p className="text-gray-400 text-sm leading-relaxed">
          <span className="text-white">Note:</span> {company.note}
        </p>
      ) : null}
    </div>
  );
      ...
      <div className="max-w-5xl mx-auto px-6 pt-28 pb-20">
        ...
        <section className="mb-20 p-8 rounded-2xl border border-white/10 bg-white/[0.03]">
          ...
          <div className="space-y-5 text-gray-300 leading-relaxed">
            ...
            <p>
              This page is a role map, not a ranking. For financing structure,
              use{" "}
        ...
        <CompanySection
          title="Production & Enrichment"
          items={productionEnrichment}
        />
        <CompanySection
          title="Medical & Radiopharmaceutical"
          items={medicalRadiopharma}
        />
        <CompanySection
          title="National & Regional Producers"
          items={nationalRegional}
        />
        <CompanySection
          title="Strategic & Nuclear Supply"
          items={strategicNuclear}
        />

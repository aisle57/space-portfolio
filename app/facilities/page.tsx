...
export default function FacilitiesPage() {
  const reactors: Facility[] = [
    ...
    },
    {
      ...
      knownFor: "Materials irradiation, research support, and selected isotope production roles.",
    },
    {
    ...
    },
    {
      ...
      knownFor: "Medical isotope production and research irradiation services.",
    },
    {
      name: "HFR Petten",
      ...
      knownFor: "Medical isotopes, including major contributions to diagnostic isotope supply chains.",
    ...
    },
    {
      ...
      knownFor: "Medical isotopes, industrial isotopes, and research support for the region.",
    },
    {
      name: "SAFARI-1",
    ...
    },
    {
      ...
      knownFor: "Medical isotope production and related nuclear research infrastructure.",
    ...
    },
    {
      ...
      knownFor: "Research irradiation and selected isotope production support.",
    },
    {
      name: "MARIA reactor",
      ...
      knownFor: "Medical isotopes and research irradiation services.",
    },
  ];
  ...
  const accelerators: Facility[] = [
    ...
    },
    {
      ...
      knownFor: "Emerging medical isotopes, research isotopes, and alternative production routes.",
    },
    {
      ...
      knownFor: "Research isotopes, method development, and advanced production R&D.",
    },
  ];
  ...
  const networks: Facility[] = [
    {
      ...
      knownFor: "Research isotopes, specialty isotopes, and strategic production coordination.",
    ...
    },
    {
      ...
      knownFor: "International reactor data, cooperation, and capacity visibility.",
    },
  ];

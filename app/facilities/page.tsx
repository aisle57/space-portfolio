...
const researchReactors: Facility[] = [
  {
    ...
    knownFor: "Medical isotopes, heavy actinides, and specialized research isotopes.",
    note:
      "A cornerstone of U.S. isotope production capability. Public reporting also places HFIR among the very small set of sources able to produce californium-252 at meaningful scale.",
  },
  {
  ...
  },
  {
    ...
    note:
      "Concentration risk example. When only a handful of reactors can make a given isotope, outage or access limits become system-level issues.",
  },
  {
    name: "PALLAS",
    ...
    knownFor: "Future Mo-99 and medical isotope irradiation capacity for Europe.",
    note:
      "Under construction. Public planning points to operation around 2030 to 2031. Important because HFR Petten is a concentrated node in current supply. Listed here, not as an active map production node.",
  },
];
...
const powerReactors: Facility[] = [
  {
    ...
    note:
      "Structurally different from dedicated research reactors. Commercial power infrastructure used for isotope output.",
  },
  {
    name: "Darlington",
...
function FacilityCard({ facility }: { facility: Facility }) {
  return (
    <div className="p-5 rounded-xl border border-white/10 bg-white/[0.03]">
      ...
      {facility.location ? (
        <p className="text-sky-400/90 text-sm mb-2">{facility.location}</p>
      ) : null}
      ...
      {facility.knownFor ? (
        <p className="text-gray-400 text-sm leading-relaxed mb-2">
          <span className="text-white">Known for:</span> {facility.knownFor}
        </p>
      ) : null}
      {facility.note ? (
        <p className="text-gray-400 text-sm leading-relaxed">
          <span className="text-white">Note:</span> {facility.note}
        </p>
      ) : null}
    </div>
  );
    ...
    <main className="h-full w-full">
      <div className="max-w-5xl mx-auto px-6 pt-28 pb-20">
        ...
        <p className="text-gray-400 text-lg leading-relaxed mb-4 max-w-3xl">
          Reactors, accelerators, and networks that turn nuclear capability into
          isotope supply.
        </p>
        ...
        <section className="mb-20 p-8 rounded-2xl border border-white/10 bg-white/[0.03]">
          ...
          <div className="space-y-5 text-gray-300 leading-relaxed">
            <p>
              ...
              system, especially for Lu-177, Mo-99 related pathways, and Co-60.
            </p>
            <p>
              Bruce Power IPS, Darlington, and Salem are the clearest current
              examples in this hub. They represent a different production route:
              commercial power infrastructure used for isotope output, not a
              dedicated research reactor built primarily for irradiation
              services.
            </p>
            <p>
        ...
        <FacilitySection title="Research Reactors" items={researchReactors} />
        <FacilitySection
          title="Power Reactor Isotope Production"
          items={powerReactors}
        />
        <FacilitySection title="Accelerators" items={accelerators} />
        <FacilitySection title="Networks & Coordination" items={networks} />

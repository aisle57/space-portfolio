        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-2">
            <span
              ...
              style={{ background: typeColors.Isotope }}
            />
            Isotope
          </div>
          <div className="flex items-center gap-2">
            <span
              className="w-2.5 h-2.5 rounded-full"
              style={{ background: typeColors.Process }}
            />
            Process
          </div>
          <div className="flex items-center gap-2">
            <span
              className="w-2.5 h-2.5 rounded-full"
              style={{ background: typeColors.Application }}
            />
            Application
          </div>
          <div className="flex items-center gap-2">
            <span
              className="w-2.5 h-2.5 rounded-full"
              style={{ background: typeColors.Facility }}
            />
            Facility
          </div>
          <div className="flex items-center gap-2">
            <span
              className="w-2.5 h-2.5 rounded-full"
              style={{ background: typeColors.Company }}
            />
            Company
          </div>
        </div>

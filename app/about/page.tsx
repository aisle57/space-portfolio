      ...
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 text-gray-300">
            ...
            <li>A curated map of selected reactors, accelerators, and enrichment sites</li>
            <li>A knowledge graph of how isotopes, processes, facilities, and companies connect</li>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-5 text-gray-300 leading-relaxed">
            <p>
              Isotope Economy is operated by <span className="text-white">Matthew Malaszuk</span>.
            </p>
            <p>
